...
;
TEST(ADXL345DRIVER, ADXL_CheckDevice_OnValidStructure_ReturnOK)
{
...
TEST(ADXL345DRIVER, ADXL_CheckDevice_OnNoConnection_ReturnError)
{
    uint8_t devidCode[2] = {0, ADXL345_DEVID_correct_code};
    mock()
        .expectOneCall("read")
...
TEST(ADXL345DRIVER, ADXL_SetMeasure_OnCorrectStructure_ReturnOk)
{
    uint8_t receive[2] = {0};
...
TEST(ADXL345DRIVER, ADXL_SetMeasure_OnLostDeviceConnection_ReturnError)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_POWER_CTL, ADXL345_SET};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetMeasure_OnLostDeviceConnectionDuring_ReturnError)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_POWER_CTL, ADXL345_SET};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetRange_OnCorrectStructure_ReturnOk)
{
    uint8_t receive[2] = {0};
...
TEST(ADXL345DRIVER, ADXL_SetRange_OnLostDeviceConnection_ReturnError)
{
    uint8_t receive[2] = {0};
...
TEST(ADXL345DRIVER, ADXL_SetRange_OnLostDeviceConnectionDuring_ReturnError)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_DATA_FORMAT, RANGE_16G};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetFullResolution_OnCorrectStructure_ReturnOk)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_DATA_FORMAT, ADXL345_SET};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetFullResolution_OnLostDeviceConnection_ReturnError)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_DATA_FORMAT, ADXL345_SET};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetFullResolution_OnLostDeviceConnectionDuring_ReturnError)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_DATA_FORMAT, ADXL345_SET};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetJustify_OnCorrectStructure_ReturnOk)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_DATA_FORMAT, ADXL345_SET};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetJustify_OnLostDeviceConnection_ReturnError)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_DATA_FORMAT, ADXL345_SET};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetJustify_OnLostDeviceConnectionDuring_ReturnError)
{
    uint8_t receive[2] = {0};
    uint8_t transfer[2] = {ADXL345_DATA_FORMAT, ADXL345_SET};
    mock()
...
TEST(ADXL345DRIVER, ADXL_SetOffset_OnCorrectStructure_ReturnOk)
{
...
TEST(ADXL345DRIVER, ADXL_SetOffset_OnNoConnection_ReturnError)
{
    uint8_t transferx[2] = {ADXL345_OFSX, 255};
    mock()
        .expectOneCall("write")
...
TEST(ADXL345DRIVER, ADXL_SetOffset_OnNoConnectionDuring_ReturnError)
{
    uint8_t transferx[2] = {ADXL345_OFSX, 255};
    uint8_t transfery[2] = {ADXL345_OFSY, 255};
...
TEST(ADXL345DRIVER, ADXL_ReadDevice_OnProperStructure_ReturnOk)
{
...
TEST(ADXL345DRIVER, ADXL_ReadDevice_OnLostConnection_ReturnError)
{
    uint8_t receivex0[2] = {0, 2};
    mock()
        .expectOneCall("read")
...
TEST(ADXL345DRIVER, ADXL_ReadDevice_OnLostConnectionDuring_ReturnError)
{
    uint8_t receivex0[2] = {0, 2};
    uint8_t receivex1[2] = {0, 4};
    uint8_t receivey0[2] = {0, 8};
...
TEST(ADXL345DRIVER, ADXL_MultiReadDevice_OnProperConnection_ReturnOk)
{
...
TEST(ADXL345DRIVER, ADXL_MultiReadDevice_OnNoConnection_ReturnError)
{
    uint8_t tx = ADXL345_MULTI_BYTE_READ | ADXL345_DATAX0;
